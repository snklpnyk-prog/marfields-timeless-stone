...
const marbles = [
  {
    ...
    image: carraraImage,
    description:
      "Classic white marble with delicate gray veining, prized for centuries in classical sculpture and architecture.",
    details:
      "Carrara marble features a pure white background with soft gray veining. Its compact grain structure and high polish retention make it perfect for both interior and exterior applications. This timeless Italian marble has been used in iconic structures worldwide.",
    characteristics: [
  ...
  },
  {
    ...
    description:
      "Luxurious white marble with bold gold and gray veining, representing the pinnacle of marble elegance.",
    details:
      "Rarer and more prestigious than Carrara, Calacatta features dramatic golden and gray veining on a bright white canvas. Its translucent quality and bold patterns make it the ultimate choice for luxury interiors.",
  ...
  },
  {
    ...
    image: marquinaImage,
    description:
      "Deep black marble with striking white calcite veins, perfect for contemporary and modern interiors.",
    details:
      "Nero Marquina's intense black color and contrasting white vein patterns create a dramatic aesthetic. This Spanish marble is ideal for creating bold statements in modern design schemes.",
  ...
  },
  {
    ...
    image: onyxImage,
    description:
      "Translucent semi-precious stone with warm amber tones that creates stunning luminous effects when backlit.",
    details:
      "Honey Onyx is a rare translucent stone with warm amber and golden tones. Its unique ability to transmit light creates breathtaking backlit features in luxury spaces.",
