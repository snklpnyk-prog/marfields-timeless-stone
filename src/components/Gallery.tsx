...
const galleryItems = [
  {
    ...
    description: "The most iconic Italian marble, prized for its pure white background with soft gray veining. Used in classical sculpture and architecture for centuries.",
    characteristics: ["Compact grain structure", "High polish retention", "Excellent for interior & exterior"],
  ...
  },
  {
    ...
    description: "Rarer and more prestigious than Carrara, featuring dramatic golden and gray veining on a bright white canvas. The pinnacle of luxury marble.",
    characteristics: ["Bold, dramatic veining", "Translucent quality", "Premium grade selection"],
  ...
  },
  {
    ...
    description: "Deep black marble with striking white calcite veins creating a dramatic contrast. Perfect for modern and contemporary interiors.",
    characteristics: ["Intense black color", "White vein patterns", "High contrast aesthetic"],
  ...
  },
  {
    ...
    description: "Translucent semi-precious stone with warm amber and golden tones. When backlit, creates a stunning luminous effect.",
  ...
  },
  {
    ...
    description: "Premium white marble with bold gray veining resembling classical statuary. Limited availability makes it highly sought after.",
    characteristics: ["Bright white base", "Prominent veining", "Statuario grade"],
    applications: ["High-End Residential", "Commercial Lobbies", "Luxury Hotels", "Premium Projects"]
  },
  {
    name: "Emperador Dark",
    image: marquinaImage,
    origin: "Spain",
    description: "Rich brown marble with white and golden veins, offering warmth and sophistication to any space.",
    characteristics: ["Chocolate brown tones", "Irregular veining", "Warm aesthetic"],
    applications: ["Flooring", "Wall Panels", "Bathroom Vanities", "Commercial Spaces"]
  }
];
