...
const steps = [
  {
    ...
    description:
      "We work directly with family-owned quarries in Carrara, Tuscany, and across Italy, ensuring authentic Italian marble with verified origin certificates.",
  },
  {
    icon: Gem,
    title: "Hand-Selected Slabs",
    description:
      "Our experts personally visit quarries to hand-select premium grade slabs, inspecting each piece for color consistency, vein patterns, and structural integrity.",
  },
  {
    icon: Truck,
    title: "Global Logistics",
    description:
      "We manage the entire supply chain from extraction to delivery, using specialized transport and handling to preserve the marble's pristine condition.",
  },
  {
    icon: CheckCircle,
    title: "Quality Certification",
    description:
      "Every shipment includes detailed documentation: quarry certificates, quality reports, and stone composition analysis for complete transparency.",
  },
];
